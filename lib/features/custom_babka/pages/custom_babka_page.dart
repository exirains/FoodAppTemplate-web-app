...
import '../../../shared/widgets/babka_app_bar.dart';
import '../providers/custom_babka_provider.dart';
import '../widgets/babka_preview.dart';
...
class _CustomBabkaPageState extends ConsumerState<CustomBabkaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final customization = ref.watch(customBabkaProvider(_currentBaseBread));
    
    final optionsAsync = ref.watch(appOptionsProvider);
    final isEnabled = optionsAsync.value?['custom_babka_enabled'] == true || 
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      BabkaPreview(baseBread: _currentBaseBread),
                      ...
                      CustomizationSection(
                        title: l10n.seeds,
                        children: babkaCustomizationOptions
            ...
            child: BabkaButton.primary(
              ...
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(l10n.addedCustomBabka)),
                );
                context.pop();
              },
            ),
