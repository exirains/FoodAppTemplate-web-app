...
/// Babka Theme Configuration (v1.1.0)
class BabkaTheme {
  static ThemeData light(Locale locale) {
    ...
    final textTheme = TextTheme(
      ...
      titleLarge: TextStyle(fontFamily: headingFont, fontSize: 18, fontWeight: FontWeight.bold, color: BabkaColors.ink),
...
/// Custom Theme Extension for Babka-specific design tokens.
