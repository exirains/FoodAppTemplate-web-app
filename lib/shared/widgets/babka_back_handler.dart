...
class BabkaBackHandler extends ConsumerStatefulWidget {
  final Widget child;
  final bool forceDoubleTap;

  const BabkaBackHandler({
    super.key,
    required this.child,
  ...
  @override
  ConsumerState<BabkaBackHandler> createState() => _BabkaBackHandlerState();
}

class _BabkaBackHandlerState extends ConsumerState<BabkaBackHandler> {
      ...
      child: Stack(
        children: [
          ...
          ExitPrompt(
            ...
            message: l10n.appName == 'Babka' ? 'Tap back again to exit' : 'برای خروج دوباره دکمه بازگشت را بزنید',
          ),
        ],
      ),
    );
